            ...
            <div class="card-body px-0 pt-0 pb-2">
              <form class="m-4" action="/pinjam" method="post">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <input type="time" name="jam_max_pinjam" id="max_pinjam" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label for="">Phone Number</label>
                  <input type="text " name="nomor_tlp" id="" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="ket_pinjam" id="" class="form-control">
                </div>
                <div class="form-group">
